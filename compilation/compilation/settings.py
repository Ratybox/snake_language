...
SECRET_KEY = 'django-insecure-b^kp0i_3ch_jvnq3(kl_ss-yqxj%qy8laal(f!k(_y6#ccln*v'
...
WSGI_APPLICATION = 'compilation.wsgi.application'
...
# Ajouter les origines autorisées pour CORS (en développement)
...
# Ajouter les en-têtes autorisés
CORS_ALLOW_HEADERS = [
    'accept',
    'accept-encoding',
    'authorization',
